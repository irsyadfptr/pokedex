        ...
        <div className='px-20 py-2 flex flex-col bg-gray-200 rounded-xl pb-8 mobile-size'>
            <div className='flex md:flex-row sm:flex-col'>
                <div className='flex flex-col flex-wrap sm:p-0 md:pr-2'>
                    ...
                    <form className=''>
                    <input className='border-2 border-gray-300 rounded-xl text-gray-600 h-10 md:pl-5 md:pr-10 sm:pl-1 sm:pr:2 bg-white hover:border-gray-400 focus:outline-none'
                        type='text'
